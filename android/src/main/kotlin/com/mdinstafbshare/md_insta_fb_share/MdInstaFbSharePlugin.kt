...
class MdInstaFbSharePlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "md_insta_fb_share_plus")
    ...
    when (call.method) {
      "share_insta_story" -> {
        if (checkAppInstalled(INSTAGRAM_PACKAGE_NAME)) {
          ...
          val backgroundTopColor = call.argument<String>("backgroundTopColor") ?: ""
          val backgroundBottomColor = call.argument<String>("backgroundBottomColor") ?: ""
